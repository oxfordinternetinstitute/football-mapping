  ...
  this['OverlappingMarkerSpiderfier'] = (function() {
    ...
    p.spiderListener = function(marker) {
      ...
      if (markerSpiderfied) {
        ...
        return this.spiderfyMarker(marker,true);
      }
    };

    p.spiderfyMarker = function(marker,click) {
      var m, mPt, markerPt, nearbyMarkerData, nonNearbyMarkers, pxSq, _i, _len, _ref;
      nearbyMarkerData = [];
      nonNearbyMarkers = [];
      ...
      if (nearbyMarkerData.length === 1) {
        return click && this.trigger('click', marker);
      } else {
